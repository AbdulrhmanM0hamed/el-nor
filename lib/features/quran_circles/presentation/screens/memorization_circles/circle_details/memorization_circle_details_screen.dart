...
class _MemorizationCircleDetailsScreenState extends State<MemorizationCircleDetailsScreen> with SingleTickerProviderStateMixin {
        ...
        body: TabBarView(
          ...
          children: [
            ...
            CircleStudentsTab(
              ...
              onEvaluationChanged: _canManageCircle ? _onEvaluationChanged : null,
              onAttendanceChanged: _canManageCircle ? _onAttendanceChanged : null,
  ...
  void _onEvaluationChanged(String studentId, int evaluation) {
    ...
    if (studentIndex != -1) {
      ...
      updatedStudents[studentIndex] = student.copyWith(evaluations: evaluations);
  ...
  void _onAttendanceChanged(String studentId, bool isPresent) {
    ...
    if (studentIndex != -1) {
      ...
      updatedStudents[studentIndex] = student.copyWith(attendance: attendance);
