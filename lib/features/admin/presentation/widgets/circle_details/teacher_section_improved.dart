...
//   // The other didUpdateWidget method above handles all cases
...
//       print('TeacherSection - Has teacher ID but no teachers loaded, showing loading state');
//     }
...
//       print('TeacherSection - Teacher IDs in list: ${widget.teachers.map((t) => t.id).join(', ')}');
//     }
...
//     if (widget.circle.teacherId != null && widget.circle.teacherId!.isNotEmpty && widget.teachers.isNotEmpty) {
//       try {
//         // First try to find by exact ID match
//         final exactMatch = widget.teachers.where((t) => t.id == widget.circle.teacherId).toList();
        
//         if (exactMatch.isNotEmpty) {
//           foundTeacher = exactMatch.first;
//           teacherFound = true;
//           print('TeacherSection - Found exact teacher match: ${foundTeacher.name}, ID: ${foundTeacher.id}');
//         } else {
//           // If no exact match, try to find by name as fallback
//           if (widget.circle.teacherName != null && widget.circle.teacherName!.isNotEmpty) {
//             final nameMatch = widget.teachers.where(
//               (t) => t.name.toLowerCase() == widget.circle.teacherName!.toLowerCase()
//             ).toList();
            
//             if (nameMatch.isNotEmpty) {
//               foundTeacher = nameMatch.first;
//               teacherFound = true;
//               print('TeacherSection - Found teacher by name: ${foundTeacher.name}, ID: ${foundTeacher.id}');
//             } else {
//               print('TeacherSection - No teacher found with ID ${widget.circle.teacherId} or name ${widget.circle.teacherName}');
//             }
//           }
//         }
...
//         if (hasProfileImage) {
//           print('TeacherSection - Profile image URL: ${foundTeacher.profileImageUrl}');
//         } else {
//           print('TeacherSection - No profile image for teacher ${foundTeacher.name}');
//         }
//       } catch (e) {
//         print('TeacherSection - Error finding teacher: $e');
//       }
//     } else {
//       print('TeacherSection - No teacher ID or empty teachers list, using default teacher');
//     }
...
//         !teacherFound) {
//       shouldShowLoading = true;
//       print('TeacherSection - Has teacher ID but teacher not found, keeping loading state');
//     }
...
//                   Row(
//                     children: [
//                       if (widget.circle.teacherId != null && widget.circle.teacherId!.isNotEmpty)
//                         ProfileImage(
...
//                 ),
//               )
//             else if (widget.circle.teacherId == null || widget.circle.teacherId!.isEmpty)
...
//                 ),
//               ),
//               if (widget.onAssignTeacher != null && !_isLoading)
//                 TextButton.icon(
//                   onPressed: widget.onAssignTeacher,
...
//     print('Showing assign teacher dialog for circle: ${widget.circle.id}, ${widget.circle.name}');
